---
website: "Serviços de Ação Social do Instituto Politécnico de Viseu"          # Entre as aspas escreve o nome do website
date: "13/07/2026"                    # Entre as aspas escreve a data de criação do 1º relatório. Os restantes estão no histórico
uri: "https://sasocial.ipv.pt/"   # Entre as aspas escreve o domínio do website
a11y_statement: "https://sasocial.ipv.pt/acessibilidade" # Entre as aspas escreve o URL da Declaração de Acessibilidade do website
owner: "Serviços de Ação Social do IP de Viseu"         # Entre as aspas escrever o nome do owner do website
